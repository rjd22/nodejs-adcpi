...
MCP3424 = (function() {
    ...
    MCP3424.prototype.getVoltage = function(chan) {
        return ((this.getMv(chan) * (this._getLsb() / this._getPga)) * 2.471)
    };
    ...
    MCP3424.prototype._getLsb = function() {
        if (this.res == MCP342X_12_BIT) {
            return 0.0005;
        }

        if (this.res == MCP342X_14_BIT) {
            return 0.000125;
        }

        if (this.res == MCP342X_16_BIT) {
            return 0.00003125;
        }

        if (this.res == MCP342X_18_BIT) {
            return 0.0000078125;
        }
    };

    MCP3424.prototype._getPga = function() {
        if (this.gain == MCP342X_GAIN_X1) {
            return 0.5;
        }

        if (this.gain == MCP342X_GAIN_X2) {
            return 1;
        }

        if (this.gain == MCP342X_GAIN_X4) {
            return 2;
        }

        if (this.gain == MCP342X_GAIN_X8) {
            return 4;
        }
    };
